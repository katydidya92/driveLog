...
public class DiveLog {
    ...
    private static void validateDiveLogArguments(
            LocalDate diveDate, LocalTime entryTime, LocalTime exitTime,
    ...
    public static DiveLog create(
            DivePoint divePoint, LocalDate diveDate, LocalTime entryTime, LocalTime exitTime,
            String weather, String buddyName, String comment
    ) {
