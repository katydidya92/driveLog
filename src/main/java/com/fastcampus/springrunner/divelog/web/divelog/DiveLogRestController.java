...
public class DiveLogRestController {
    ...
    public ResponseEntity<?> register(
            ...
            @RequestBody @Validated DiveLogRegisterRequest registerRequest,
            BindingResult bindingResult
    ) {

        ResponseEntity<Map<String, String>> errorMaps = getErrorResponse(bindingResult);
        if (errorMaps != null) return errorMaps;
    ...
    public ResponseEntity<?> update(
            @PathVariable("diveLogId") Long diveLogId,
            @RequestBody @Validated DiveLogUpdateRequest request,
            BindingResult bindingResult
    ) {
    ...
    private static ResponseEntity<Map<String, String>> getErrorResponse(BindingResult bindingResult) {
